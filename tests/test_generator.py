...
class GeneratorTests(unittest.TestCase):
    ...
    def test_mobile_layout_and_reduced_motion(self):
        ...
        self.assertFalse(self.page.locator('#design-options').evaluate('(el) => el.open'))
        self.page.locator('#url-input').fill('https://example.com/mobile-download')
        self.ready()
        self.assertTrue(self.page.locator('#dl-png').is_visible())
        self.page.locator('#url-input').focus()
        self.page.keyboard.press('Tab')
        self.assertEqual('SUMMARY', self.page.evaluate('document.activeElement.tagName'))
        self.page.keyboard.press('Tab')
        self.assertEqual('png-size', self.page.evaluate('document.activeElement.id'))
        self.page.keyboard.press('Tab')
        self.assertEqual('dl-png', self.page.evaluate('document.activeElement.id'))
        self.page.locator('#design-options summary').click()
        self.assertTrue(self.page.locator('#design-options').evaluate('(el) => el.open'))
